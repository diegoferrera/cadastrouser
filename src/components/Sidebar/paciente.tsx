            ...
            <div className="w-64 absolute sm:relative bg-gray-300 shadow md:h-full flex-col justify-between hidden sm:flex">
                <div className="px-8">
                    <div className="h-16 w-full flex items-center">
                       <p className="text-2xl text-gray-400 font-medium">Nome Paciente</p>
                  
                    </div>
                    <div className="w-full flex items-center">
                       <p className="font-medium"><FaUserAlt size={60}/></p>
                    </div>
                    <ul className="mt-6">
                    <li className="flex w-full justify-between text-gray-500 hover:text-green-500 cursor-pointer items-center mb-2 pb-2 border-gray-400 border-b">
                        ...
                        <li className="flex w-full justify-between text-gray-600 hover:text-green-500 cursor-pointer items-center mb-2 pb-2 border-gray-400 border-b">
                            <div className="flex items-center">
                                ...
                                <span className="text-lg font-medium  ml-2">Aval. Laboratoriais</span>
                            </div>
                        </li>
                        <li className="flex w-full justify-between text-gray-600 hover:text-green-500 cursor-pointer items-center mb-2 pb-2 border-gray-400 border-b">
                            <div className="flex items-center">
