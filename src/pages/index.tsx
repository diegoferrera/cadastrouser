                ...
                <div className="xl:px-2 md:px-2 sm:px-2 px-2 md:py-2 py-2 2xl:mx-auto 2xl:container md:flex items-center justify-center">
                    ...
                    <div className="bg-white shadow-lg rounded xl:w-1/2 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
                        ...
                        <button aria-label="Continue with github" role="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3 border rounded-lg border-gray-700 flex items-center w-full mt-4 hover:bg-gray-100">
                            ...
                            <p className="text-base font-medium ml-4 text-gray-700">Continuar Com Github</p>
                        </button>
                        <button aria-label="Continue with twitter" role="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3 border rounded-lg border-gray-700 flex items-center w-full mt-4 hover:bg-gray-100">
                            ...
                            <p className="text-base font-medium ml-4 text-gray-700">Continuar Com Twitter</p>
                        </button>
                        ...
                        <div className="mt-6 w-full">
                            ...
                            <div className="relative flex items-center justify-center">
                                <input id="myInput" type={showpass ? "text" : "password"} className="bg-gray-200 border rounded text-xs font-medium leading-none text-gray-700 py-3 w-full pl-3 mt-2" />
