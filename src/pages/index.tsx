                ...
                <div className="xl:px-2 md:px-2 sm:px-2 px-2 md:py-2 py-2 2xl:mx-auto 2xl:container md:flex items-center justify-center">
                    ...
                    <div className="bg-white shadow-lg rounded xl:w-1/2 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
                        ...
                        <button aria-label="Continue with google" role="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3 border rounded-lg border-gray-700 flex items-center w-full mt-10 hover:bg-gray-100">
                            ...
                            <p className="text-base font-medium ml-4 text-gray-700">Continuar Com Google</p>
                        </button>
                       
                        
                        <div className="w-full flex items-center justify-between py-5">
                            <hr className="w-full bg-gray-700" />
                            <p className="text-base font-medium leading-4 px-2.5 text-gray-500">OU</p>
                            <hr className="w-full bg-gray-700" />
                        </div>
                        <div>
                            ...
                            <input id="email" aria-labelledby="email" type="email" className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-400 text-gray-400 py-3 w-full pl-3 mt-2" placeholder="nome@gmail.com " />
                        </div>
                        <div className="mt-6 w-full">
                            ...
                            <div className="relative flex items-center justify-center">
                                <input id="myInput" type={showpass ? "text" : "password"} className="bg-gray-200 border rounded text-xs font-medium leading-none text-gray-400 py-3 w-full pl-3 mt-2" placeholder="********" />
                        ...
                        <Link href="/dashboard" passHref>
                            <button role="button" className="focus:ring-2 focus:ring-offset-2 focus:ring-green-700 text-sm font-semibold leading-none text-white focus:outline-none bg-green-300 border rounded hover:bg-green-500 py-4 w-full">
                                Login
                            </button>
                        </Link>
                        </div>
                    ...
                    <div className="xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6">
                        ...
                        <h1 className="text-6xl font-light text-green-300">ONCO<span className="text-purple-700 font-bold">NUTRI</span></h1>
                        </div>
                        <div className="flex items-start mt-8">
                            ...
                            <p className="sm:text-2xl text-xl leading-7 text-gray-600 pl-2.5">Uma plataforma inovadora que traz diversas facilidades para o dia-a-dia do nutricionista. </p>
                        </div>
